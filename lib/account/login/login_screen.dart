...
import 'package:HoFiMeFu/shared/repository/http_utils.dart';
...
class LoginScreen extends StatelessWidget {
  LoginScreen({Key? key}) : super(key: HoFiMeFuKeys.mainScreen);
    ...
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        if(state.status.isSubmissionSuccess){
          Navigator.pushNamed(context, HoFiMeFuRoutes.main);
        }
      },
      child: Scaffold(
          appBar: AppBar(
  ...
  Widget register(BuildContext context) {
    return ElevatedButton(
      ...
      onPressed: () => Navigator.pushNamed(context, HoFiMeFuRoutes.register),
    );
  }
